              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-gray-700 shadow-lg">
                  ...
                  {loading ? (
                    ...
                    <div>
                      <div className="mb-6">
                        ...
                        <MusicUpload
                          onUploadSuccess={() => fetchRecentData()}
                        />
                      </div>
                      ...
                      {recentTracks.length > 0 ? (
                        <div className="space-y-2">
                          {recentTracks.map((track) => (
                            <div
                              key={track.id}
                              className="bg-gray-700/50 p-3 rounded-md flex justify-between items-center"
                            >
                  ...
                  <div className="mt-4 text-center">
                    <Link
                      href="/admin/music"
                      className="inline-block bg-blue-700 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-colors"
                    >
                      Quản lý tất cả nhạc
                    </Link>
                  </div>
