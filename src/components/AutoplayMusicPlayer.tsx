...
export default function AutoplayMusicPlayer() {
  ...
  const [activeVisualEffect, setActiveVisualEffect] = useState<string | null>(
    null
  ); // Current active visual effect
  ...
  useEffect(() => {
    ...
    loadTrack();
  }, [currentTrackIndex, tracks]); // eslint-disable-line react-hooks/exhaustive-deps
