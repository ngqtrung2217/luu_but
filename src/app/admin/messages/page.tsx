  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Quản lý Lưu bút</h1>
        ...
        <div className="flex space-x-4 mt-4 md:mt-0">
          ...
          <Link href="/admin/music" className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-md transition-colors">
            Quản lý Nhạc
          </Link>
        </div>
      </div>
        ...
        {filteredEntries.map((entry) => (
          ...
          >
            <div className="p-5">
              ...
              {entry.email && (
                <p className="text-sm text-blue-400 mb-3 truncate">{entry.email}</p>
              )}
      ...
      {filteredEntries.length === 0 && !loading && (
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-8 text-center">
          ...
          <h3 className="text-xl font-medium text-gray-400 mb-1">Không có lưu bút nào</h3>
          <p className="text-gray-500">
            {searchTerm ? "Không tìm thấy lưu bút nào phù hợp với từ khóa tìm kiếm" : "Chưa có lưu bút nào được gửi"}
          </p>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="p-6">
              ...
              {selectedEntry.email && (
                <p className="text-sm text-blue-400 mb-4">{selectedEntry.email}</p>
              )}
              
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-gray-400 uppercase mb-2">Thông tin</h4>
                <div className="bg-gray-900/50 rounded-md p-3 text-gray-300 text-sm">
                  <p><span className="font-medium text-gray-400">ID:</span> {selectedEntry.id}</p>
                  <p><span className="font-medium text-gray-400">Ngày gửi:</span> {new Date(selectedEntry.created_at).toLocaleString("vi-VN")}</p>
                </div>
              </div>
              
              <div>
                <h4 className="text-sm font-semibold text-gray-400 uppercase mb-2">Nội dung lưu bút</h4>
